...
},{"angular-hint-controllers":2,"angular-hint-directives":3,"angular-hint-dom":32,"angular-hint-events":34,"angular-hint-interpolation":44,"angular-hint-log":54,"angular-hint-modules":55}],2:[function(require,module,exports){
    'use strict';
...
},{"./lib/getModule":59,"./lib/moduleData":66,"./lib/start":69,"./lib/storeDependencies":70,"./lib/storeNgAppAndView":71,"./lib/storeUsedModules":72,"angular-hint-log":54}],56:[function(require,module,exports){
    module.exports = function(s,t) {
        var strMap = {},
            similarities = 0,
            STRICTNESS = 0.66;
...
},{"./moduleData":66}],59:[function(require,module,exports){
    var modData = require('./moduleData');
...
},{"./moduleData":66}],60:[function(require,module,exports){
...
},{"./areSimilarEnough":56,"./levenshtein":65,"./moduleData":66}],62:[function(require,module,exports){
...
},{"./getModule":59,"./getSuggestion":61}],63:[function(require,module,exports){
    var getModule = require('./getModule');
...
},{"./getModule":59}],64:[function(require,module,exports){
    var normalizeAttribute = require('./normalizeAttribute');
...
},{"./normalizeAttribute":68}],65:[function(require,module,exports){
...
},{"./getModule":59,"./moduleData":66}],68:[function(require,module,exports){
    module.exports = function(attribute) {
        return attribute.replace(/^(?:data|x)[-_:]/,'').replace(/[:_]/g,'-');
    };
...
},{"./display":57,"./formatMultiLoaded":58,"./getUndeclaredModules":62,"./getUnusedModules":63,"./moduleData":66,"./ngViewNoNgRoute":67}],70:[function(require,module,exports){
    var modData = require('./moduleData');
...
},{"./moduleData":66}],71:[function(require,module,exports){
...
},{"./getNgAppMod":60,"./inAttrsOrClasses":64,"./moduleData":66,"./storeDependencies":70}],72:[function(require,module,exports){
    var storeDependencies = require('./storeDependencies');
